...
date: 2023-07-08
draft: false
tags: ["python", "mysql", "gitea", "rce", "file-misconfiguration", "searchor 2.4.0", "docker", "docker-inspect"]
htb: "HacktheBox"
linux: "Linux"
---
...
![etc hosts file 1](etc-hosts-1.png)
...
![searcher index page](searcher-index-page.png)
...
![searcher index footage page](searcher-index-footer-page.png)
...
![github vulnerable code](github-code-vuln.png)
...
![reading the config file](reading-config-file.png)

![etc hosts file 2](etc-hosts-2.png)
...
![gitea login as cody](gitea-login-as-cody.png)

However, there are `two` users on it, which is the user that I used for login now and the `administrator` user.

![gitea show administrator commit](gitea-show-administrator-commit.png)
...
![check user exist on the box](check-user.png)
...
![check the sudo permission](sudo-permission.png)
...
![system-checkup menu](system-checkup-help-menu-full-checkup-command.png)
...
![system-checkup docker-ps](docker-ps-list.png)
...
![system-checkup docker-inspect](system-checkup-docker-inspect.png)
...
![dump mysql docker config](dump-mysql-docker-config.png)
...
![found the docker ip address](docker-ip-address.png)
...
![login as root mysql](mysql-login-as-root.png)
...
![administrator gitea repository](administrator-gitea-repos.png)
...
![full-checkup source code](source-code-of-full-checkup-command.png)
...
![system-checkup source code](source-code-of-system-checkup.png)
...
![ran the script in the different directory](ran-the-script-in-the-different-directory.png)
...
![becoming root](becoming-root.png)
